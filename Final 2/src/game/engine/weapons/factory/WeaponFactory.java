...
public class WeaponFactory
{
	...
	public void addWeaponToShop(int code, int price, int damage, String name, String type)
	{
		this.getWeaponShop().put(code, new WeaponRegistry(code, price, damage, name, type));
	}

	public void addWeaponToShop(int code, int price, int damage, String name, int minRange, int maxRange, String type)
	{
		this.getWeaponShop().put(code, new WeaponRegistry(code, price, damage, name, minRange, maxRange, type));
	}
